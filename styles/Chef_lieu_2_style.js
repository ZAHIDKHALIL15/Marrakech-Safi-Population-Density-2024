...
var style_Chef_lieu_2 = function(feature, resolution){
    ...
    if ("" !== null) {
        ...
        image: new ol.style.Circle({radius: 2.2 + size,
            stroke: new ol.style.Stroke({color: 'rgba(223,43,43,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(220,36,36,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
